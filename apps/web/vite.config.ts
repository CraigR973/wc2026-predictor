  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        ...
        'brand/calcio-icon-primary.svg',
        'brand/calcio-icon-primary-512.png',
        'brand/calcio-icon-dark.svg',
        'brand/calcio-icon-gold.svg',
        'brand/calcio-mark.svg',
        'brand/calcio-mark-mono.svg',
        'brand/calcio-mark-gold.svg',
