...
import { clearApiCaches, clearTokens, getAccessToken, getRefreshToken, getStoredPlayer, storeTokens, StoredPlayer } from '../lib/tokens';
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const initialRequiresUnlock = !!initialPlayer && !!getRefreshToken();
