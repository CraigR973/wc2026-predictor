...
| U51 | 🟢 Sonnet | Join code hotfix: rotate UI race (stale code shown after rotation), iOS autocorrect on code input, auth join-by-code rate limit too tight (10→30/hour) | | 🚀 Shipping |
